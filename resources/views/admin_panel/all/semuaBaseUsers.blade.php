                ...
                <div class="content place">
                    <div class="content area">
                        <table>
                            ...
                            @foreach($baseUsersAll as $baseUsers)
                            <tr>
                                <td> {{ $no++ }}</td>
                                <td> {{ $baseUsers->name }} </td>
                                <td> {{ $baseUsers->email }} </td>
                                <td> {{ $baseUsers->alamat }} </td>
                                <td> {{ $baseUsers->provinsi }} </td>
                                <td> {{ $baseUsers->aktif }} </td>
                                <td> {{ HTML::linkRoute('users.edit', 'EDIT',  $baseUsers->id) }} </td>
                                <td> <input type="checkbox" name="delete[]" value="{{ $baseUsers->id }}"> </td>
                                {{ csrf_field() }}
                            </tr>
                            @endforeach
                        </table>
