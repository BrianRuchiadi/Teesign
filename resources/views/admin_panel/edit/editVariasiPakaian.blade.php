                        ...
                        <table>
                            <tr>               
                                ...
                                <td> <select name="size" required>
                                        ...
                                        <option value="{{ $size->id }}" @if( $retrieve->size == $size->id ) selected @endif >{{ $size->nama_referensi }}</option>
                                        @endforeach
                                    </select></td>
                            </tr>
                            <tr>
                                ...
                                <td> <select name="jenis_pakaian" required>
                                        ...
                                        <option value="{{ $jenisPakaian->id }}" @if( $retrieve->jenis_pakaian == $jenisPakaian->id ) selected @endif >{{ $jenisPakaian->nama }}</option>
                                        @endforeach
                                    </select></td>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <select name="bahan_print_pakaian" required>
                                        ...
                                        <option value="{{ $bahanPrintPakaian->id }}" @if( $retrieve->bahan_print_pakaian == $bahanPrintPakaian->id ) selected @endif >{{ $bahanPrintPakaian->nama }} </option>
                                        @endforeach
                                    </select> </td>
                            </tr>
                            <tr>
                                ...
                                <td> <select name="warna_pakaian">
                                        ...
                                        <option value="{{ $warnaPakaian->id }}" @if( $retrieve->warna_pakaian == $warnaPakaian->id ) selected @endif >{{ $warnaPakaian->nama }}</option>
                                        @endforeach
                                    </select></td>
                            </tr>
                            <tr>
                                ...
                                <td> <select name="luas_daerah_print">
                                        ...
                                        <option value="{{ $luasDaerahPrint->id }}" @if( $retrieve->luas_daerah_print == $luasDaerahPrint->id ) selected @endif >{{ $luasDaerahPrint->nama_referensi }}</option>
                                        @endforeach
                                    </select>
                            </tr>
                            <tr>
                                ...
                                <td> <select name="aktif">
                                        <option value="0" @if( $retrieve->aktif == 0 ) selected @endif> Tidak aktif </option>
